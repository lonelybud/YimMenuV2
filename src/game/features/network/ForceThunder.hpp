...
{
	class ForceThunder : public LoopState
	{
	...
	inline ForceThunder _ForceThunder{"forcethunder", "Force Thunder", "Forces the weather to thunder for all players in the session"};
}