...
namespace YimMenu::Features
{
	...
	class LSCCustomsBypass : public BoolState
	{
	...
	inline LSCCustomsBypass _LSCCustomsBypass{"lsccustomsbypass", "Remove LSC Restrictions", "Removes Los Santos Customs vehicle modification restrictions"};
}