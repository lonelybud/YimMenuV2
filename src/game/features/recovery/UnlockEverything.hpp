...
namespace YimMenu::UnlockEverything
{
	inline void unlock_packed_bools_simple()
	{
		...
		FiberPool::Push([] {
			...
			unlock_packed_bools(32318, 32323); //--Service Carbine (FREE), police5 trade price
			...
			// https://www.unknowncheats.me/forum/grand-theft-auto-v/578963-packed-stats-int-bool-collection-thread-5.html#post3754864
			Stats::SetPackedBool(15534, true);
			Stats::SetPackedBool(22193, true);
			Stats::SetPackedBool(27089, true);
			Stats::SetPackedBool(27090, true);
			Stats::SetPackedBool(27245, true);
			Stats::SetPackedBool(28155, true);
			Stats::SetPackedBool(28256, true);
			Stats::SetPackedBool(28257, true);
			Stats::SetPackedBool(30309, true);
			Stats::SetPackedBool(32325, true);

			Stats::SetBool("MPPLY_FEATURED_COMMUNITY_JOB", true); // https://www.unknowncheats.me/forum/grand-theft-auto-v/578963-packed-stats-int-bool-collection-thread-47.html#post4549660

			// https://www.unknowncheats.me/forum/grand-theft-auto-v/578963-packed-stats-int-bool-collection-thread-51.html#post4600393
			Stats::SetPackedBool(18139, true); // * Skip Facility TDH Intro (Set up a Facility and meet Lester Crest)
			Stats::SetPackedBool(22106, true); // Skip Nightclub Intro
			Stats::SetPackedBool(22080, true); // Nightclub Setup - Resident DJ recruitment
			Stats::SetPackedBool(28155, true); // Skip Arcade Intro
			Stats::SetPackedBool(22193, true); // Skip Auto Shop Intro
			Stats::SetPackedBool(42038, true); // * Skip Salvage Yard Intro (Meet with Yusuf Amir)
			Stats::SetPackedBool(9537, true);  // * Skip Bail Office Intro (Meet with Maude Eccles)
			Stats::SetPackedBool(9540, true);  // Skip Mckenzie Field Hangar Intro
			Stats::SetPackedBool(9539, true);  // * Skip Garment Factory Intro (Meet with Pavel)
			Stats::SetPackedBool(28310, true); // Skip Hands On Car Wash Intro
			Stats::SetPackedBool(28256, true); // Skip Agency Intro
			Stats::SetPackedBool(27090, true); // * Skip Casino Intro (Visit The Diamond Casino & Resort)
			Stats::SetPackedBool(27089, true); // * Skip Casino Penthouse Intro (Purchase a Penthouse and visit Agatha Baker)
			Stats::SetPackedBool(25008, true); // Skip Arena War Intro
			Stats::SetPackedBool(25009, true); // * Skip Arena War Setup (Set up an Arena Workshop / The Rookie Outfit)
			Stats::SetPackedBool(31737, true); // * Skip LSCM Intro Cutscene (Visit and become a member of the LS Car Meet)
			Stats::SetPackedBool(54768, true); // Mansion Intro Cutscene

			unlock_packed_bools(51192, 51195); // https://www.unknowncheats.me/forum/grand-theft-auto-v/707419-lua-scripts-yimmenuv2-collection-thread-12.html#post4539651
			unlock_packed_bools(54787, 54817); // mantion tropies
			Stats::SetPackedBool(60105, true); // https://www.unknowncheats.me/forum/grand-theft-auto-v/578963-packed-stats-int-bool-collection-thread-55.html#post4741090
			unlock_packed_bools(60000, 60009); // https://www.unknowncheats.me/forum/grand-theft-auto-v/578963-packed-stats-int-bool-collection-thread-55.html#post4741090

			// https://www.unknowncheats.me/forum/grand-theft-auto-v/578963-packed-stats-int-bool-collection-thread-55.html#post4741090
			Stats::SetPackedBool(60010, true); // Ghosts Exposed Jacket
			unlock_packed_bools(60029, 60030); // Kortz T-Shirt (Career Progress Reward), Kortz Bomber Jacket (Career Progress Reward)
			unlock_packed_bools(60065, 60094); // Light Blue SN Varsity, Brown Go Hard! Leather Jacket, Ride or Die Chore, Blagueurs Star Bomber Zipped, Blue Fade Güffy Bomber Zipped, Orange Manor Bomber Zipped, Blue Camo Yeti Bomber Zipped, Pink SN x PRB Bomber Zipped, Beige Dog Blagueurs Hoodie, Haute Couture Blagueurs Hoodie, Beige Dog Blagueurs T-Shirt, Trickter Skull T-Shirt, Pop Art Revere Collar, Bigness Patchwork Revere Collar, Blagueurs Star Cuffed Sweats, Blue Fade Güffy Cuffed Sweats, Blue Camo Yeti Cuffed Sweats, Trickter Skull Cuffed Sweats, Bigness Patchwork Jeans, Ride or Die Jeans, Sprunk Sweatsuit, Camo Ammu-Nation Sweatsuit, Impotent Rage Sweatsuit, Rebel Radio Sweatsuit, eCola Tracksuit, Junk Tracksuit, WCC Tracksuit, Princess Racing Tracksuit, Yeti x LS Customs Tracksuit, Retro Fruit Tracksuit

		});
	}

	inline void unlock_paints()
	{
		FiberPool::Push([] {
	...
	inline void set_misc()
	{
		FiberPool::Push([] {
			// https://github.com/YimMenu-Lua/UnlockEverything/blob/main/WasabiWords.lua
			{
				...
				Stats::SetPackedBool(59971, true);
				Stats::SetPackedBool(36839, true);
				Stats::SetPackedBool(36843, true);
				Stats::SetPackedBool(36841, true);
				...
				Stats::SetPackedInt(41242, 8);
				Stats::SetPackedInt(24928, 10);
				Stats::SetPackedInt(24929, 14);
				Stats::SetFloat("MPX_PILOT_ELAPSEDTIME_0", 58.0f);
				Stats::SetFloat("MPX_PILOT_LANDINGDISTANCE_1", 10.0f);
				Stats::SetFloat("MPX_PILOT_LANDINGDISTANCE_2", 2.0f);
				Stats::SetFloat("MPX_PILOT_LANDINGDISTANCE_3", 10.0f);
				Stats::SetFloat("MPX_PILOT_ELAPSEDTIME_4", 19.0f);
				Stats::SetFloat("MPX_PILOT_LANDINGDISTANCE_5", 600.0f);
				Stats::SetFloat("MPX_PILOT_LANDINGDISTANCE_6", 25.0f);
				Stats::SetFloat("MPX_PILOT_LANDINGDISTANCE_7", 1.0f);
				Stats::SetFloat("MPX_PILOT_ELAPSEDTIME_8", 160.0f);
				Stats::SetFloat("MPX_PILOT_ELAPSEDTIME_9", 145.0f);
				Stats::SetFloat("MPX_PILOT_LASTELAPSEDTIME_0", 58.0f);
				Stats::SetFloat("MPX_PILOT_LASTLANDDISTANCE_1", 10.0f);
				Stats::SetFloat("MPX_PILOT_LASTLANDDISTANCE_2", 2.0f);
				Stats::SetFloat("MPX_PILOT_LASTLANDDISTANCE_3", 10.0f);
				Stats::SetFloat("MPX_PILOT_LASTELAPSEDTIME_4", 19.0f);
				Stats::SetFloat("MPX_PILOT_LASTLANDDISTANCE_5", 600.0f);
				Stats::SetFloat("MPX_PILOT_LASTLANDDISTANCE_6", 25.0f);
				Stats::SetFloat("MPX_PILOT_LASTLANDDISTANCE_7", 1.0f);
				Stats::SetFloat("MPX_PILOT_LASTELAPSEDTIME_8", 160.0f);
				Stats::SetFloat("MPX_PILOT_LASTELAPSEDTIME_9", 145.0f);
				...
				Stats::SetInt("MPX_CRBNRIFLE_ENEMY_KILLS", 500);
				...
				Stats::SetInt("MPX_HVYSNIPER_ENEMY_KILLS", 500);
				Stats::SetInt("MPX_GRNLAUNCH_ENEMY_KILLS", 500);
				Stats::SetInt("MPX_MINIGUNS_ENEMY_KILLS", 500);
				...
				Stats::SetInt("MPX_ARENAWARS_MATCHES_PLYD", 52500);
				Stats::SetInt("MPX_ARENAWARS_MATCHES_PLYDT", 52500);
				Stats::SetInt("MPX_ARENAWARS_CARRER_WINS", 72500);
				Stats::SetInt("MPX_ARENAWARS_CARRER_WINT", 32500);
				Stats::SetInt("MPX_ARN_LIFETIME_KILLS", 260000);
				Stats::SetInt("MPX_ARN_LIFETIME_DEATHS", 20000);
				Stats::SetInt("MPX_ARN_SPECTATOR_KILLS", 5000);
				Stats::SetInt("MPX_ARN_W_PASS_THE_BOMB", 11000);
				Stats::SetInt("MPX_ARN_W_DETONATION", 11000);
				Stats::SetInt("MPX_ARN_W_ARCADE_RACE", 11000);
				Stats::SetInt("MPX_ARN_W_CTF", 11000);
				Stats::SetInt("MPX_ARN_W_TAG_TEAM", 11000);
				Stats::SetInt("MPX_ARN_W_DESTR_DERBY", 11000);
				Stats::SetInt("MPX_ARN_W_CARNAGE", 11000);
				Stats::SetInt("MPX_ARN_W_MONSTER_JAM", 12000);
				Stats::SetInt("MPX_ARN_W_GAMES_MASTERS", 11000);
				...
				unlock_packed_bools(28313, 28318);
				unlock_packed_bools(54737, 54761);
			}

			// // https://www.unknowncheats.me/forum/grand-theft-auto-v/578963-packed-stats-int-bool-collection-thread-45.html#post4540660
			// Stats::SetInt("MPX_MTM_COUNT_0", 1);
			// Stats::SetInt("MPX_MTM_COUNT_1", 1);
			// Stats::SetInt("MPX_MTM_COUNT_2", 1);
			// Stats::SetInt("MPPLY_MANSION_DISCOUNT_STATE", 1);
			// Stats::SetPackedBool(54670, true);

			// Stats::SetInt("MPX_M25_GENERAL_BS", 16511);       // https://www.unknowncheats.me/forum/4539241-post138.html
		});
	}
	...
	public:
		...
		_StatUnlockMech(std::vector<std::shared_ptr<StatCommon>>& t) :
		    _stats(t)
		{
		}
