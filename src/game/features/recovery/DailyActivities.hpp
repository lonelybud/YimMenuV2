...
namespace YimMenu::Features
{
	...
	class CollectGoldenClover : public CallCode
	{
		using CallCode::CallCode;
	...
	inline CollectGoldenClover _CollectGoldenClover{"collectgoldenclover", "Collect Golden Clover", "Collects the Golden Clover."};
}